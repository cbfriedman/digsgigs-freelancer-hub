      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold">For Clients (Posting Gigs)</h2>
          </div>
          ...
          <Card className="bg-accent/5 border-accent/20">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">100% Free for Clients</h3>
                  <p className="text-muted-foreground">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold">For Diggers (Service Providers)</h2>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of professionals and clients connecting on DiggsAndGiggs
          </p>
          <div className="flex gap-4 justify-center">
            <Button size="lg" onClick={() => navigate("/auth?redirect=/post-gig")}>
              Post a Gig
            </Button>
            <Button variant="outline" size="lg" onClick={() => navigate("/auth?type=digger&redirect=/digger-registration")}>
              Become a Digger
            </Button>
          </div>
        </div>
