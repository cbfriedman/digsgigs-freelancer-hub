...
const Auth = () => {
  ...
  const [userType, setUserType] = useState<"digger" | "consumer">("consumer");
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-primary p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold">DiggsAndGiggs</CardTitle>
          <CardDescription>Welcome back! Sign in to your account or create a new one.</CardDescription>
        </CardHeader>
        <CardContent>
