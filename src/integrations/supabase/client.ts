...
if (!import.meta.env.VITE_SUPABASE_URL || !import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY) {
  ...
  if (import.meta.env.DEV) {
    logger.warn('⚠️ Using hardcoded Supabase configuration fallback values due to missing environment variables. This indicates a Lovable Cloud platform issue.');
  }
