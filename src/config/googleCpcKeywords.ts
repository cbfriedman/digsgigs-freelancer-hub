...
export const GOOGLE_CPC_KEYWORDS: IndustryCpcData[] = [
  ...
  // Credit Repair - High-value financial services (YMYL category)
  {
    industry: 'Credit Repair',
    category: 'high-value',
    averageCpc: 145,
    keywords: [
      { keyword: 'credit repair services', cpc: 285, searchVolume: 49500, competitionLevel: 'high' },
      { keyword: 'credit repair companies', cpc: 265, searchVolume: 40500, competitionLevel: 'high' },
      { keyword: 'best credit repair', cpc: 245, searchVolume: 33100, competitionLevel: 'high' },
      { keyword: 'credit repair near me', cpc: 225, searchVolume: 27100, competitionLevel: 'high' },
      { keyword: 'credit restoration services', cpc: 205, searchVolume: 22200, competitionLevel: 'high' },
      { keyword: 'fix my credit score', cpc: 195, searchVolume: 33100, competitionLevel: 'high' },
      { keyword: 'bad credit repair', cpc: 185, searchVolume: 18100, competitionLevel: 'high' },
      { keyword: 'credit dispute services', cpc: 175, searchVolume: 14800, competitionLevel: 'high' },
      { keyword: 'credit repair specialist', cpc: 165, searchVolume: 12100, competitionLevel: 'high' },
      { keyword: 'credit score improvement', cpc: 155, searchVolume: 22200, competitionLevel: 'high' },
      { keyword: 'credit repair consultation', cpc: 145, searchVolume: 9900, competitionLevel: 'high' },
      { keyword: 'credit counseling services', cpc: 135, searchVolume: 18100, competitionLevel: 'high' },
      { keyword: 'professional credit repair', cpc: 125, searchVolume: 8100, competitionLevel: 'high' },
      { keyword: 'fast credit repair', cpc: 115, searchVolume: 14800, competitionLevel: 'high' },
      { keyword: 'legitimate credit repair', cpc: 105, searchVolume: 6600, competitionLevel: 'high' },
      { keyword: 'credit repair attorney', cpc: 95, searchVolume: 5400, competitionLevel: 'medium' },
      { keyword: 'credit bureau disputes', cpc: 90, searchVolume: 8100, competitionLevel: 'medium' },
      { keyword: 'remove negative credit', cpc: 85, searchVolume: 12100, competitionLevel: 'medium' },
      { keyword: 'collection account removal', cpc: 80, searchVolume: 9900, competitionLevel: 'medium' },
      { keyword: 'credit repair for mortgage', cpc: 75, searchVolume: 6600, competitionLevel: 'medium' },
    ],
  },
  {
