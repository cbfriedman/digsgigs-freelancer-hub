...
const INDUSTRIES: IndustryData[] = [
  ...
  { name: "Construction", avgCPC: 14, clickToLeadRate: 0.07, leadToCustomerRate: 0.14 },
  { name: "Automotive Services", avgCPC: 8, clickToLeadRate: 0.10, leadToCustomerRate: 0.20 },
  { name: "Architects", avgCPC: 16, clickToLeadRate: 0.05, leadToCustomerRate: 0.10 },
  { name: "Engineers", avgCPC: 15, clickToLeadRate: 0.06, leadToCustomerRate: 0.12 },
  { name: "Legal Services", avgCPC: 18, clickToLeadRate: 0.04, leadToCustomerRate: 0.08 },
  { name: "Financial Services", avgCPC: 17, clickToLeadRate: 0.05, leadToCustomerRate: 0.10 },
  { name: "Therapists and Counseling", avgCPC: 10, clickToLeadRate: 0.08, leadToCustomerRate: 0.15 },
  { name: "Fitness and Nutrition", avgCPC: 7, clickToLeadRate: 0.12, leadToCustomerRate: 0.25 },
  { name: "Education and Tutoring", avgCPC: 9, clickToLeadRate: 0.10, leadToCustomerRate: 0.20 },
  { name: "Event Planning", avgCPC: 11, clickToLeadRate: 0.09, leadToCustomerRate: 0.18 },
  { name: "Pet Services", avgCPC: 8, clickToLeadRate: 0.11, leadToCustomerRate: 0.22 },
  { name: "Design Services", avgCPC: 12, clickToLeadRate: 0.08, leadToCustomerRate: 0.16 },
  { name: "Hi Tech and Digital Media", avgCPC: 14, clickToLeadRate: 0.07, leadToCustomerRate: 0.14 },
];
