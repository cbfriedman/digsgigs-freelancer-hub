...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const staticPages = [
      ...
      { url: '/faq/credit-repair', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/tax-relief', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/legal-services', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/insurance', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/mortgage-financing', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/financial-services', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/technology-services', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/medical-healthcare', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/automotive', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/pet-care', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/education-tutoring', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/fitness-wellness', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/event-services', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/cleaning-maintenance', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/moving-storage', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/beauty-personal-care', priority: '0.7', changefreq: 'monthly' },
      { url: '/faq/hiring-contractors', priority: '0.7', changefreq: 'monthly' },
      // Comparison Pages
