...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    if (type === 'submitted') {
      ...
      // Notify digger they're awarded; they must accept within 24h or $100 penalty; decline = $100 penalty
      ...
      if (diggerEmail) {
        emailResponse = await resend.emails.send({
          from: "Digs and Gigs <noreply@digsandgigs.net>",
          to: [diggerEmail],
          subject: `You're awarded: "${gig.title}" – accept within 24 hours`,
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
              <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 25px; text-align: center; border-radius: 10px 10px 0 0;">
                <h1 style="margin: 0; font-size: 24px;">You're awarded</h1>
                <p style="margin: 10px 0 0 0; opacity: 0.9;">The client awarded you this gig – accept within 24 hours</p>
              </div>
              <div style="padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
                ...
                <p>Accept within 24 hours or you'll be charged a $100 penalty. If you decline, you'll be charged a $100 penalty and the client gets their deposit back.</p>
                <div style="text-align: center; margin: 25px 0;">
