-- Add muted and is_blocked to get_my_conversations for Messages UI.
...
COMMENT ON FUNCTION public.get_my_conversations() IS
  'Returns all conversations with last message, partner avatar URLs, unread count, muted, and is_blocked.';
