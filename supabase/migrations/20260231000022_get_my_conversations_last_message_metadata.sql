-- Add last_message_metadata to get_my_conversations so chat list can show award symbol for award events.
...
COMMENT ON FUNCTION public.get_my_conversations() IS
  'Returns all conversations with last message, metadata, partner avatar URLs, unread count, muted, and is_blocked.';
