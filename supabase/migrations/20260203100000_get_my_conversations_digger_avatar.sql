-- Add digger profile image URL to get_my_conversations for Messages avatar.
...
COMMENT ON FUNCTION public.get_my_conversations() IS
  'Returns all conversations the current user can access (including admin support convos), with last message preview and digger avatar URL.';
