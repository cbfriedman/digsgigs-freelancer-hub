  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in-down": "fade-in-down 0s ease-out",
        "fade-out": "fade-out 0s ease-out",
        "scale-in": "scale-in 0s ease-out",
        "scale-out": "scale-out 0s ease-out",
        "slide-in-right": "slide-in-right 0s ease-out",
        "slide-out-right": "slide-out-right 0s ease-out",
        "slide-in-left": "slide-in-left 0s ease-out",
        "bounce-in": "bounce-in 0s cubic-bezier(0.68, -0.55, 0.265, 1.55)",
        float: "float 0s ease-in-out infinite",
        pulse: "pulse 0s cubic-bezier(0.4, 0, 0.6, 1) infinite",
